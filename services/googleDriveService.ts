 ...
 */
export const initClient = (clientId: string): Promise<void> => {
 ...
 */
export const saveData = async (folderId: string, data: string): Promise<any> => {
 ...
 */
export const listBackups = async (folderId: string): Promise<any[]> => {
    const response = await gapi.client.drive.files.list({
 ...
 */
export const loadData = async (fileId: string): Promise<string | null> => {
    try {
