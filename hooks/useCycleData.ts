...
import type { CycleInfo, UserData } from '../types';
import { addDays, differenceInDays, predictCycleLength } from '../utils/helpers';

// Extend CycleInfo to include userData for components that need it
export type CycleInfoWithUserData = CycleInfo & { userData: UserData };

export const useCycleData = (): CycleInfoWithUserData | null => {
  ...
  return useMemo(() => {
    ...
    let currentPhase: CycleInfo['currentPhase'] = 'Follicular';
